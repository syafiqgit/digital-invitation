...
const scatterItems = [
  ...
  { top: "25%", left: "88%", type: "leaf", rot: 25 },
  { top: "48%", left: "6%", type: "bloom", color: "var(--coral)" },
  { top: "72%", left: "92%", type: "bloom", color: "var(--blush-dark)" },
  { top: "90%", left: "12%", type: "leaf", rot: -30 },
] as const;
...
const fireflies = [
  ...
  { left: "15%", bottom: "68%", duration: 7.5, delay: 3 },
  { left: "85%", bottom: "58%", duration: 9, delay: 2 },
].map((f) => ({
  ...f,
...
const petals = [
  ...
  { left: "88%", size: 6, duration: 13, delay: 2, color: "var(--coral)" },
].map((p) => ({
  ...p,
...
const butterflies = [
  ...
  { left: "85%", top: "75%", color: "var(--burgundy)", duration: 18, delay: 3 },
  ...
  return (
    <section className="relative flex min-h-dvh w-full flex-col items-center justify-center overflow-hidden bg-ivory px-4 py-20 sm:px-6 sm:py-28">
      ...
      >
        ...
        <m.div
          variants={containerVariants}
          className="grid w-full grid-cols-2 gap-3 sm:gap-6 md:grid-cols-3"
        >
          {photos.map((url, index) => (
            <m.div
              ...
              className="group relative aspect-[4/5] cursor-pointer overflow-hidden rounded-3xl border-[1.5px] border-mustard/50 bg-ivory/95 p-2 shadow-[0_10px_30px_rgba(58,54,48,0.1)] sm:p-3"
              style={GPU_HINT}
            >
              <div className="relative h-full w-full overflow-hidden rounded-2xl">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-ink/40 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100 flex items-end p-4">
        ...
        {selectedPhoto && (
          ...
          >
            <m.div
              ...
              className="relative max-h-[85dvh] max-w-3xl overflow-hidden rounded-3xl border-2 border-mustard/60 bg-ivory p-3 shadow-2xl sm:p-4"
            ...
            >
              ...
              <button
                type="button"
                onClick={() => setSelectedPhoto(null)}
                className="absolute right-4 top-4 rounded-full bg-burgundy px-3 py-1.5 text-xs font-bold text-white shadow-md hover:bg-burgundy/90"
              >
                Tutup
              </button>
            </m.div>
