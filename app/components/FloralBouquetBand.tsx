...
function FloralBouquetBand({
  ...
  return (
    ...
    >
      ...
      {/* Bunga detail - beberapa cluster kiri & kanan */}
      {[
        { x: 55, y: 45, s: 1.1, c: "#c96b63" },
        { x: 90, y: 25, s: 0.8, c: "#d9a5a0" },
        { x: 30, y: 75, s: 0.9, c: "#f0d9d4" },
        { x: 1145, y: 45, s: 1.1, c: "#c96b63" },
        { x: 1110, y: 25, s: 0.8, c: "#d9a5a0" },
        { x: 1170, y: 75, s: 0.9, c: "#f0d9d4" },
        { x: 600, y: 25, s: 0.7, c: "#d9a5a0" },
      ].map((f, i) => (
